...
| Device      | Integration    | Physical board and current meter / user-assisted                            | Battery-side current, BLE, audio and all buttons             |
